...
Source0  : https://files.pythonhosted.org/packages/4f/45/347101de0cd2b29c941552cbe380021b4de341f8c3c7f4d5debb96a10e78/cliff-2.18.0.tar.gz
...
%prep
%setup -q -n cliff-2.18.0
cd %{_builddir}/cliff-2.18.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578598983
...
cp %{_builddir}/cliff-2.18.0/LICENSE %{buildroot}/usr/share/package-licenses/cliff/2b8b815229aa8a61e483fb4ba0588b8b6c491890
