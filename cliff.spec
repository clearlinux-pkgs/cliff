...
Source0  : https://files.pythonhosted.org/packages/25/3e/d970b4fc5a88a61014c96be4c2a446c6a228833fc1e97bc9e236deb59560/cliff-3.2.0.tar.gz
...
%prep
%setup -q -n cliff-3.2.0
cd %{_builddir}/cliff-3.2.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591802059
...
cp %{_builddir}/cliff-3.2.0/LICENSE %{buildroot}/usr/share/package-licenses/cliff/2b8b815229aa8a61e483fb4ba0588b8b6c491890
