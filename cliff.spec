...
%prep
%setup -q -n cliff-3.0.0
cd %{_builddir}/cliff-3.0.0
%patch1 -p1
...
cp %{_builddir}/cliff-3.0.0/LICENSE %{buildroot}/usr/share/package-licenses/cliff/2b8b815229aa8a61e483fb4ba0588b8b6c491890
